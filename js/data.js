...
const timelineData = [
  {
    icon: "📢", title: "Election Announcement",
    ...
    links: [
      ...
      { label: "Election Schedule & Press Notes", url: "https://eci.gov.in/elections/current-elections/" }
    ]
  },
  {
    icon: "📋", title: "Model Code of Conduct (MCC)",
    ...
    links: [
      ...
      { label: "Report Violation (cVIGIL App)", url: "https://play.google.com/store/apps/details?id=in.nic.eci.cvigil" }
    ]
  },
  {
    icon: "🗳️", title: "Voter List Finalization",
    ...
    links: [
      { label: "Search Voter List", url: "https://voters.eci.gov.in" },
      { label: "Voter Registration Portal", url: "https://voterportal.eci.gov.in" },
      { label: "Voter Helpline App", url: "https://play.google.com/store/apps/details?id=com.eci.citizen" }
    ]
  },
  {
    icon: "📝", title: "Filing of Nominations",
    ...
    links: [
      { label: "Candidate Affidavits (MyNeta)", url: "https://myneta.info" },
      { label: "Nomination Forms & Guidelines", url: "https://eci.gov.in/candidate-political-parties/" }
    ]
  },
  {
    icon: "✅", title: "Scrutiny of Nominations",
    ...
    links: [
      ...
      { label: "RP Act 1951", url: "https://legislative.gov.in/actsofparliamentfromtheyear/representation-people-act-1951" }
    ]
  },
  {
    icon: "🚪", title: "Withdrawal of Candidature",
    ...
    links: [
      { label: "ECI Election Schedule", url: "https://eci.gov.in/elections/current-elections/" },
      { label: "Final Candidate List", url: "https://affidavit.eci.gov.in" }
    ]
  },
  {
    icon: "📣", title: "Election Campaign",
    ...
    links: [
      { label: "Report Violations (cVIGIL)", url: "https://play.google.com/store/apps/details?id=in.nic.eci.cvigil" },
      { label: "Spending Limits & Rules", url: "https://eci.gov.in/mcc/" }
    ]
  },
  {
    icon: "🤫", title: "Silence Period",
    ...
    links: [
      { label: "Section 126 — RP Act", url: "https://legislative.gov.in/actsofparliamentfromtheyear/representation-people-act-1951" }
    ]
  },
  {
    icon: "🗳️", title: "Polling Day",
    ...
    links: [
      { label: "Find Your Polling Booth", url: "https://voters.eci.gov.in" },
      { label: "Voter Helpline: 1950", url: "tel:1950" },
      { label: "Voter Helpline App", url: "https://play.google.com/store/apps/details?id=com.eci.citizen" }
    ]
  },
  {
    icon: "🏆", title: "Vote Counting and Result",
    ...
    links: [
      { label: "Live Election Results", url: "https://results.eci.gov.in" },
      { label: "Results Archive", url: "https://results.eci.gov.in/ResultAc498/index.htm" }
    ]
  },
  {
    icon: "🧐", title: "Check Eligibility",
    summary: "Verify if you meet the criteria to vote in Indian elections.",
    detail: "To be eligible to vote, you must be a citizen of India, at least 18 years old on the qualifying date (January 1st, April 1st, July 1st, or October 1st of the year), and a resident of the polling area. You must not be disqualified due to unsoundness of mind or criminal conviction.",
    why: "Ensures only qualified citizens participate in the democratic process, maintaining the integrity of the electorate.",
    example: "If you turn 18 on June 15, you can register during the next quarterly update (July 1st).",
    violated: "Voting without eligibility is a legal offence. Providing false information during registration can lead to fines and imprisonment.",
    simple: "Like checking if you are old enough to drive — you need to be 18 and a citizen to get your 'voter license'!",
    links: [
      { label: "Register to Vote (Form 6)", url: "https://voterportal.eci.gov.in" },
      { label: "Check Voter List Status", url: "https://voters.eci.gov.in" }
    ]
  },
  {
    icon: "📝", title: "Register to Vote",
    summary: "Apply for inclusion in the electoral roll via Form 6.",
    detail: "Eligible citizens must apply to the Electoral Registration Officer using Form 6. This can be done online at voterportal.eci.gov.in or via the Voter Helpline App. You need a photo, age proof, and address proof. Once verified by a Booth Level Officer (BLO), your name is added to the roll.",
    why: "Being 18 is not enough—your name must be on the official list to cast a vote. This prevents booth-level confusion on election day.",
    example: "Over 1.8 crore first-time voters registered for the 2024 elections using the online portal.",
    violated: "Attempting to register in two different places is illegal. Always move your registration using Form 8 if you change your residence.",
    simple: "Like signing up for a club — you can't just show up, you have to be on the member list first!",
    links: [
      { label: "Register Online (Form 6)", url: "https://voterportal.eci.gov.in" },
      { label: "Voter Helpline App", url: "https://play.google.com/store/apps/details?id=com.eci.citizen" },
      { label: "Voter Helpline: 1950", url: "tel:1950" }
    ]
  },
  {
    icon: "📍", title: "Find Polling Booth",
    summary: "Locate your assigned polling station.",
    detail: "Voters are assigned to specific polling stations based on their residence. You can find yours on your Voter Slip or by searching your EPIC number on the ECI portal. Most booths are located in schools or community centers within 2km of your home.",
    why: "Organized polling stations prevent overcrowding and ensure every voter has a local place to vote without traveling long distances.",
    example: "The ECI set up a booth for a single voter in the Gir Forest of Gujarat to ensure every citizen can vote.",
    violated: "Going to the wrong booth means you cannot vote. Always check your voter slip before leaving home.",
    simple: "Like knowing which classroom to go to for an exam — check your slip so you don't get lost!",
    links: [
      { label: "Find Your Booth", url: "https://voters.eci.gov.in" },
      { label: "Voter Helpline App", url: "https://play.google.com/store/apps/details?id=com.eci.citizen" }
    ]
  },
  {
    icon: "⚖️", title: "Eligibility to Contest",
    summary: "Criteria for becoming a candidate for Lok Sabha.",
    detail: "To contest for Lok Sabha, you must be a citizen of India, at least 25 years old, and a registered voter. You must not hold an office of profit under the government and must not have certain criminal convictions.",
    why: "Ensures that representatives are mature, qualified, and have no conflicting interests with their public duties.",
    example: "A 24-year-old cannot contest Lok Sabha elections, as the minimum age is 25.",
    violated: "Ineligible candidates who win can have their election declared void by the High Court.",
    simple: "Like qualifying to be a team captain — you have to meet the age and skill requirements first!",
    links: [
      { label: "Candidate Guidelines", url: "https://eci.gov.in/candidate-political-parties/" },
      { label: "RP Act 1951", url: "https://legislative.gov.in/actsofparliamentfromtheyear/representation-people-act-1951" }
    ]
  },
  {
    icon: "📁", title: "File Nomination",
    summary: "Submit your candidacy to the Returning Officer.",
    detail: "Candidates must submit nomination papers along with an affidavit (Form 26) declaring their assets, liabilities, and criminal records. A security deposit is required (₹25,000 for General, ₹12,500 for SC/ST).",
    why: "Transparency allows voters to see who the candidate is, what they own, and if they have a criminal past before voting.",
    example: "Candidates in 2024 were required to publish their criminal records in newspapers three times during the campaign.",
    violated: "Hiding assets or criminal cases in the affidavit can lead to disqualification and legal action.",
    simple: "Like applying for a job — you have to submit your resume and background check to the boss (ECI).",
    links: [
      { label: "Candidate Affidavits", url: "https://affidavit.eci.gov.in" },
      { label: "Know Your Candidate (MyNeta)", url: "https://myneta.info" }
    ]
  }
];
